...
interface GloabalNotificationProps {}

export const GloabalNotification: React.FC<GloabalNotificationProps> = () => {
              ...
              <div className='flex items-start'>
                ...
                <div className='ml-3 w-0 flex-1 pt-0.5'>
                  ...
                  <p className='mt-1 text-sm text-white'>
                    This is Rubi Logistics Central Adminstrative Control Panel
                  </p>
                </div>
