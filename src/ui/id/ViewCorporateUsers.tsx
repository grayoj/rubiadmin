          ...
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-lg text-white">
                ...
                on the Rubi Logistics platform.{" "}
                    ...
                    {user?.status === "APPROVED" || "ENABLED"
                      ? (
                        <button
                          ...
                          className="mx-4 bg-productGreen inline-flex items-center justify-center rounded-md border border-transparent bg-product px-4 py-2 text-sm font-medium text-white shadow-sm sm:w-auto"
                        >
                          Approve Account
                        </button>
                      )
                      : (
                        <button className="mx-4 cursor-not-allowed inline-flex items-center justify-center rounded-md border border-transparent bg-productGreen px-4 py-2 text-sm font-medium text-white shadow-sm sm:w-auto">
                          Approve Account
                        </button>
                      )}
